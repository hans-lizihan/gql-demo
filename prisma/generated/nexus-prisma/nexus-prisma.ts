...
type UserObject =
  ...
  | { name: 'uuid', args?: [] | false, alias?: string  } 
...
export type UserWhereInputInputObject =
  ...
  | { name: 'id_ends_with', alias?: string  } 
  | { name: 'id_not_ends_with', alias?: string  } 
  | { name: 'uuid', alias?: string  } 
  | { name: 'uuid_not', alias?: string  } 
  | { name: 'uuid_in', alias?: string  } 
  | { name: 'uuid_not_in', alias?: string  } 
  | { name: 'uuid_lt', alias?: string  } 
  | { name: 'uuid_lte', alias?: string  } 
  | { name: 'uuid_gt', alias?: string  } 
  | { name: 'uuid_gte', alias?: string  } 
  | { name: 'uuid_contains', alias?: string  } 
  | { name: 'uuid_not_contains', alias?: string  } 
  | { name: 'uuid_starts_with', alias?: string  } 
  | { name: 'uuid_not_starts_with', alias?: string  } 
  | { name: 'uuid_ends_with', alias?: string  } 
  | { name: 'uuid_not_ends_with', alias?: string  } 
